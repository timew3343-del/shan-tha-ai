...
export const AIToolsTab = ({ userId }: AIToolsTabProps) => {
  ...
  const tools: ToolDef[] = useMemo(() => [
    ...
    { id: "fashiondesigner", icon: Shirt, titleKey: "", fallbackTitle: "AI Fashion Designer PRO", descKey: "", fallbackDesc: "ဖက်ရှင်ဒီဇိုင်း + Technical Sketch", gradient: "bg-gradient-to-br from-pink-500 via-rose-600 to-fuchsia-700", credits: (costs as any).fashion_designer || 8, category: ["premium", "fashion", "image"], badge: "PRO" },
    // Image
