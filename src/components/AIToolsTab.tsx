...
const CATEGORIES: { key: ToolCategory; label: string; icon: any }[] = [
  ...
  { key: "fashion", label: "ဖက်ရှင် ဒီဇိုင်းပိုင်း", icon: Shirt },
...
export const AIToolsTab = ({ userId }: AIToolsTabProps) => {
  ...
  const tools: ToolDef[] = useMemo(() => [
    ...
    { id: "videoredesign", icon: Wand2, titleKey: "", fallbackTitle: "AI Video Redesign", descKey: "", fallbackDesc: "ဗီဒီယို Style ပြောင်း", gradient: "bg-gradient-to-br from-violet-500 via-fuchsia-600 to-pink-700", credits: costs.video_redesign, category: ["premium", "video"], badge: "PREMIUM" },
    { id: "characteranimate", icon: Sparkles, titleKey: "", fallbackTitle: "ရုပ်ပုံ လှုပ်ရှားသက်ဝင်စေ", descKey: "", fallbackDesc: "ရုပ်ပုံ + ကကွက်ဗီဒီယို → Animation", gradient: "bg-gradient-to-br from-amber-500 via-orange-600 to-red-700", credits: (costs as any).character_animate || 21, category: ["premium", "video"], badge: "PREMIUM" },
    { id: "videomulti", icon: Film, titleKey: "", fallbackTitle: "AI Video Multi-Tool", descKey: "", fallbackDesc: "လင့်ထည့် အော်တို vedio ထုပ်", gradient: "bg-gradient-to-br from-purple-600 via-violet-600 to-fuchsia-700", credits: (costs as any).video_multi || 10, category: ["premium", "video"], badge: "PRO" },
    { id: "fashiondesigner", icon: Shirt, titleKey: "", fallbackTitle: "AI Fashion Designer PRO", descKey: "", fallbackDesc: "အဆင့်မြင့် AI အဝတ်အထည် ဒီဇိုင်းဖန်တီးသူ", gradient: "bg-gradient-to-br from-pink-500 via-rose-600 to-fuchsia-700", credits: (costs as any).fashion_designer || 8, category: ["premium", "fashion", "image"], badge: "PRO" },
    // Image
    ...
    { id: "bgstudio", icon: Palette, titleKey: "", fallbackTitle: "AI Background Studio", descKey: "", fallbackDesc: "ပစ္စည်းပုံများအတွက် အလန်းစား နောက်ခံစတူဒီယို", gradient: "bg-gradient-to-br from-violet-500 via-purple-600 to-fuchsia-700", credits: costs.bg_studio, category: ["image"], size: "small", badge: "NEW" },
    { id: "logodesign", icon: PenTool, titleKey: "", fallbackTitle: "Logo & Graphic Design Studio", descKey: "", fallbackDesc: "လိုဂို နှင့် ဂရပ်ဖစ်ဒီဇိုင်း ဖန်တီးပေးခြင်း", gradient: "bg-gradient-to-br from-pink-500 via-rose-600 to-red-700", credits: costs.logo_design, category: ["image"], size: "small", badge: "NEW" },
    { id: "photorestore", icon: ImagePlus, titleKey: "", fallbackTitle: "AI Photo Restore & Enhancement", descKey: "", fallbackDesc: "ဓာတ်ပုံဟောင်းများ ပြုပြင်ခြင်းနှင့် ကြည်လင်အောင်လုပ်ခြင်း", gradient: "bg-gradient-to-br from-amber-500 via-orange-600 to-red-700", credits: costs.photo_restoration, category: ["image"], badge: "NEW" },
    { id: "virtualtryon", icon: Shirt, titleKey: "", fallbackTitle: "AI အင်္ကျီလဲဝတ်ကြည့်", descKey: "", fallbackDesc: "အဝတ်အစား စမ်းဝတ်ကြည့်", gradient: "bg-gradient-to-br from-pink-500 via-rose-600 to-red-700", credits: costs.virtual_tryon, category: ["image", "fashion"], badge: "NEW" },
              ...
              {activeCategory === "all" && !searchQuery.trim() ? (
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { key: "fashion" as ToolCategory, label: "👗 ဖက်ရှင် ဒီဇိုင်းပိုင်း", icon: Shirt },
